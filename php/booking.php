    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        ?>
            ...
            <h5> Fare:&nbsp;<b> <?php echo("RM " . $ac_price . "/hour");?></b></h5>
        ...
        <?php $today = date("Y-m-d") ?>
          ...
          <label><h5>Duration: &nbsp; 
          <input id="duration" type="text" name="duration" placeholder="Duration" required=""> /hour</h5></label>

        <br><br>
            
            <input type="hidden" name="hidden_carid" value="<?php echo $car_id; ?>">
            <input type="hidden" name="hidden_fare" value="<?php echo $ac_price; ?>">
