        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <ul class="nav navbar-nav">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Return Car <span class="caret"></span> </a>
                <ul class="dropdown-menu">
...
$id = $_GET["id"];
$distance = NULL;
$duration = $conn->real_escape_string($_POST['hid_duration']);
...
if ($result1){
     $sql2 = "UPDATE cars c, rentedcars rc SET c.car_availability='yes', rc.return_status='$return_status', rc.car_return_date='$car_return_date'
