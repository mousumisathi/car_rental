...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
 $sql1 = "SELECT c.car_name, c.car_nameplate, rc.rent_start_date, rc.rent_end_date, rc.fare, rc.duration, rc.total_amount
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your driver to fill the below form </h6>
           ...
           <h5> Fare:&nbsp;  RM <?php echo($fare. " /hour");?></h5>

           <h5> Duration:&nbsp; <?php echo($duration. " hour");?></h5>

           <h5> Number of Day(s):&nbsp;  <?php echo($no_of_days);?></h5>

           <h5> Total Amount:&nbsp; RM <?php echo($total_amount);?></h5>

          <input type="hidden" name="hid_duration" value="<?php echo $duration; ?>">
