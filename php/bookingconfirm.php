...
<?php
    ...
    $fare = $conn->real_escape_string($_POST['hidden_fare']);
    $rent_start_date = date('Y-m-d', strtotime($_POST['rent_start_date']));
    $rent_end_date = date('Y-m-d', strtotime($_POST['rent_end_date']));
    $duration = $conn->real_escape_string($_POST['duration']);
    $total_amount = $duration * $fare;
    ...
    if($err_date >= 0) { 
    $sql1 = "INSERT into rentedcars(customer_username,car_id,booking_date,rent_start_date,rent_end_date,fare,duration,return_status,total_amount) 
    VALUES('" . $customer_username . "','" . $car_id . "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $duration . "','" . $return_status . "','" . $total_amount . "')";
    ...
    $sql3 = "SELECT * FROM  cars c, clients cl, rentedcars rc WHERE c.car_id = '$car_id'";
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
              ...
              <li> <a href="clientview.php">Booking History</a></li>
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <ul class="nav navbar-nav">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Booking Info <span class="caret"></span> </a>
                <ul class="dropdown-menu">
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                <br>
                <h4> <strong>Fare:</strong> RM <?php echo $fare; ?>/hour</h4>
                <br>
